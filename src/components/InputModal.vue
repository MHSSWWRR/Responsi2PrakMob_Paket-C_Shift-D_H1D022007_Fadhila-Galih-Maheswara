...
<template>
    <ion-modal :is-open="isOpen" @did-dismiss="cancel">
        ...
        <ion-content>
            <ion-item>
                <ion-input v-model="Toy.title" label="Title" label-placement="floating"
                    placeholder="Enter Title"></ion-input>
            </ion-item>
            <ion-item>
                <ion-textarea v-model="Toy.description" label="Description" label-placement="floating"
...
import { Toy } from '@/utils/firestore';
